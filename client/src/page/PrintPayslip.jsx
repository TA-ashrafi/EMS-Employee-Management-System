      ...
      <div className="print:hidden space-y-6">
        ...
        {loading ? (
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-12 text-center shadow-xs">
            ...
            <h3 className="mt-4 text-base font-bold text-slate-800">No Payslips Issued Yet</h3>
                ...
                <tbody className="divide-y divide-slate-100">
                  {payslips.map((item) => (
                    <tr key={item.id || item._id} className="hover:bg-amber-50/30 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap font-semibold text-rose-500">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-xl bg-slate-900 px-3.5 py-2 text-xs font-bold text-yellow-400 shadow-xs hover:bg-slate-800 transition-colors"
                        >
          ...
          <div className="w-full max-w-2xl rounded-3xl bg-white p-6 sm:p-10 shadow-2xl space-y-6 print:shadow-none print:max-w-none print:p-0">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-4 print:hidden">
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={handlePrint}
                  className="flex items-center gap-2 rounded-xl bg-yellow-400 px-4 py-2 text-xs font-extrabold text-slate-950 hover:bg-yellow-300 shadow-xs"
                >
            ...
            <div id="printable-payslip" className="space-y-6 bg-white p-2">
              {/* Header */}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs">
          <div className="w-full max-w-lg rounded-3xl bg-white p-6 sm:p-8 shadow-2xl space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <h2 className="text-xl font-black text-slate-900">Generate Payslip</h2>
              <button
            ...
            <form onSubmit={handleGenerateSubmit} className="space-y-4">
              ...
              <div className="rounded-2xl bg-amber-50 p-4 border border-amber-200 text-xs font-bold text-slate-800 flex justify-between items-center">
